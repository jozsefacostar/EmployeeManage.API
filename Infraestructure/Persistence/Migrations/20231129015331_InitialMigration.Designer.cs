...
namespace _03.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20231129015331_InitialMigration")]
            ...
            modelBuilder.Entity("Domain.Permission.Permission", b =>
                {
                    ...
                    b.Property<Guid>("EmployeeNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("PermissionTypeNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PermissionTypeNavigationId");
            ...
            modelBuilder.Entity("Domain.Permission.Permission", b =>
                {
                    ...
                    b.HasOne("Domain.PermissionType.PermissionType", "PermissionTypeNavigation")
                        .WithMany("Permissions")
                        .HasForeignKey("PermissionTypeNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
